...
\begin{equation*}
    H^{(\mathrm m)} \to - \frac{1}{2}\omega_{\mathrm m} \sigma_3  - \frac{1}{2} \lambda_q \sin 2\theta_{\mathrm m}  \cos\left( k_0 r \right) \sigma_1.
\end{equation*}
