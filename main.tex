...
\fbox{
\parbox{\columnwidth}{Include a plot of potential in Eq.~(\ref{eq-castle-wall-potential})
Explain why this is important. \bf{Same to the the single frequency profile.}
}
}
