...
Even for the single frequency matter profile, there are two modes of Rabi oscillations under the approximation that the varying $\sigma_3$ term in Hamiltonian is neglected, as mentioned in Sec.~\ref{sec:single}. The three examples calculated in Fig.~\ref{fig-rabiOscillationsNeutrinoCoincidence} are almost exact since the modification of relative detuning for the $k_1$ mode that we kept due to the far off resonance mode $-k_1$ that we neglected is tiny, as shown in the first two lines of Table.~\ref{tab-q-values-lambda-each-mode-interference}, where $n=\pm 1$ are for the $\pm k_1$ modes. We observe that the relative detuning of the $k_1$ due to the $-k_1$ mode is not observable in the examples.
...
\subsection{Multi-frequency Matter Profile}


Using Jacobi-Anger expansion, two-frequency matter profile can also be analyzed. We calculate the two frequency matter profile with Hamiltonian

\begin{widetext}
\begin{equation}
H^{(\mathrm m)} =  -\frac{\omega_{\mathrm{m}}}{2} \sigma_3 + \frac{1}{2} \sum_{n=1}^2 \cos 2\theta_{\mathrm m} A_n \sin (k_n r) \sigma_3  - \frac{1}{2} \sum_{n=1}^2 \sin 2\theta_{\mathrm m} A_n \cos (k_n r) \sigma_1 .
...
% {
%%%%%  {{-1, 20}, 0., 4.20892*10^50},
%%%%%%%  {{0, 10}, 0., 1.25313*10^21},
%  {{1, 0}, 0., 325026.},
%%%%%%  {{2, -10}, 0., 1.17958*10^30},
%%%%%%  {{3, -20}, 0., 1.18857*10^60},
%  {{0, 1}, 465.071, 3246.81},
%  {{0, -1}, 568.42, 3246.81},
%  {{0, 2}, 8965.27, 70413.1},
%  {{0, -2}, 13447.9, 70413.1},
%  {{1, 1}, 101914., 6.40346*10^6},
%  {{-1, 0}, 103459., 325026.},
%  {{1, -1}, 124562., 7.82645*10^6},
%  {{0, 3}, 340310., 3.05462*10^6},
%  {{0, -3}, 632005., 3.05462*10^6},
%  {{-1, -1}, 2.1402*10^6, 6.40346*10^6}
% }

% {
%  {{1, 0}, 0., 4.08067*10^6},
%  {{1, 2}, 130.747, 4.10753*10^6},
%  {{1, -2}, 130.799, 4.10917*10^6},
%  {{1, 1}, 209.094, 1.31378*10^7},
%  {{1, -1}, 209.136, 1.31404*10^7},
%  {{1, 4}, 267.643, 4.20413*10^6},
%  {{1, -4}, 267.858, 4.2075*10^6},
%  {{1, 6}, 422.045, 4.41965*10^6},
%  {{1, -6}, 422.552, 4.42496*10^6},
%  {{1, 3}, 550.734, 1.15346*10^7},
%  {{1, -3}, 551.065, 1.15415*10^7},
%  {{1, 8}, 619.504, 4.86557*10^6},
%  {{1, -8}, 620.496, 4.87336*10^6},
%  {{1, 5}, 741.244, 9.31475*10^6},
%  {{1, -5}, 741.986, 9.32407*10^6}
% }

% {
%  {{1, 0, 0}, 0., 2.76694*10^7},
%  {{1, -35, 11}, 8.95625, 3.9946*10^7},
%  {{1, 35, -11}, 8.95628, 3.99461*10^7},
%  {{1, -19, 6}, 60.4489, 3.85231*10^7},
%  {{1, 19, -6}, 60.4501, 3.85239*10^7},
%  {{1, -54, 17}, 65.8547, 3.67212*10^7},
%  {{1, 54, -17}, 65.8562, 3.67221*10^7},
%  {{1, 51, -16}, 114.9, 1.02522*10^8},
%  {{1, -51, 16}, 114.902, 1.02523*10^8},
%  {{1, 13, -4}, 120.309, 2.82479*10^7},
%  {{1, -13, 4}, 120.316, 2.82494*10^7},
%  {{1, 29, -9}, 147.648, 2.63469*10^7},
%  {{1, -29, 9}, 147.659, 2.63487*10^7},
%  {{1, 48, -15}, 157.795, 3.91081*10^7},
%  {{1, -48, 15}, 157.803, 3.911*10^7}
% }
...
% {1,1} &	608730.  &       19.7392      &  \{1,3\}  &	   &      &  {1,-22,12} &	111.436 &    162934.\\
% {1,-1} &	$1.17721\times10^6$  &   19.7392  & \{1,-3\} &	  &  & {1,22,-12} &	111.443  & 163032.\\
\end{tabular}
\end{ruledtabular} 
\end{table*}
