...
Fig.~\ref{fig-interference-reduction-three-modes-rabi} shows an intriguing phenomenon we observe. We construct a system with three pairs of frequencies, with each pair rotating in a different direction,
\begin{equation}
