...
\begin{equation}
\frac{\mathrm d}{\mathrm dt} \mathbf{s} = \mathbf{s} \times (\mathbf{H}_3 + \mathbf{H}_+ - \mathbf{H}'_3),
\end{equation}
where
\begin{equation}
\mathbf{H}'_3 = \begin{pmatrix}
