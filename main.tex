...
Another well researched matter profile is the castle wall matter profile, which is periodic and within one period we have
\begin{equation}
...
\Lambda_q & = \frac{2}{(2q-1)\pi}  \left( \lambda_1 -  \lambda_2 \right) (-1)^q .
\end{align*}
