...
\begin{equation*}
    ...
    0 &  \Phi_n e^{\mathrm i n k_1  x} \\
     \Phi_n^* e^{ - \mathrm i n k_1 x} & 0
    \end{pmatrix},
\end{equation*}
%\end{widetext}
where
...
\begin{equation}
    ...
    \begin{pmatrix}
    0 & \Phi_N e^{i\left( \sum_a n_a k_a \right)x} \\
    \Phi_N^* e^{-i\left( \sum_a n_a k_a \right)x} & 0
    \end{pmatrix},
\end{equation}
\end{widetext}
where
...
For the single frequency matter profile discussed in Sec.~\ref{sec:single-freq}, 
