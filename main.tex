...
We develop an Rabi oscillations interpretation of neutrino oscillations in matter by neglecting the insignificant terms. The interference as a result of multi-frequency driving field is also explored and criteria of interference is proposed and verified numerically. Precise mapping into Rabi oscillations by expanding the system into superpositions of Rabi oscillations is made to explain the approximations made in the simple picture as well as providing more quantitative criteria on the interference effect.
...
In this paper we have provided an novel interpretation for neutrino oscillation in matter. By intuition, we interpreted the neutrino oscillations in a single frequency matter profile as Rabi oscillations when the system is close to resonance. Without any Jacobi-Anger expansion, we anticipated the varying diagonal elements in Hamiltonian have limited effects, which was shown using Jacobi-Anger expansion that the varying diagonal elements can be negelected by virtue of the solitary on resonance mode.
