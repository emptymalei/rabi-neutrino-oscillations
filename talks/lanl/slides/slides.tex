...
\begin{equation*}
    \mathbf {H} = \frac{1}{2}\left( - \omega_{\mathrm{m}} + {\color{red}A\sin(kx)} \cos 2\theta_{\mathrm{m}} \right) \sigma_3 - \frac{  {\color{red}A\sin \theta_{\mathrm{m}}}  }{2} \sin(kx)  \sigma_1.
\end{equation*}
...
\begin{equation*}
    -\frac{\omega_0}{2} \sigma_3 - \alpha \sin(k t)\sigma_1
\end{equation*}
\end{tcolorbox}
...
\small
\begin{equation*}
   \frac{1}{2}\left( - \omega_{\mathrm{m}} + {\color{red}A\sin(kx)} \cos 2\theta_{\mathrm{m}} \right) \sigma_3 - \frac{  {\color{red}A\sin \theta_{\mathrm{m}}}  }{2} \sin(kx)  \sigma_1
\end{equation*}
\end{textblock*}
...
\begin{equation*}
    P_{1\to 2} = \frac{\alpha^2}{\Omega_{\mathrm R}^2} \sin^2 \left( \frac{\Omega_{\mathrm R}}{2} t \right).
\end{equation*}
